                        ...
                        .listener(new RequestListener<Drawable>() {
                            ...
                            public boolean onResourceReady(Drawable resource, Object model, Target<Drawable> target, DataSource dataSource, boolean isFirstResource) {
                                ...
                                if (URLUtil.isValidUrl(String.valueOf(trailerInput.getText())) && id!=-1) {
                                    newCateItem=new ArrayList<>();
                                    newCateItem.clear();
                                    CateItem newItem=new CateItem(cateItem.getId(),String.valueOf(nameInput.getText()),String.valueOf(bannerInput.getText()),String.valueOf(trailerInput.getText()),idCate,cateItem.getRating(),cateItem.getLuotThich());
